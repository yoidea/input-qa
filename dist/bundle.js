!(function(e) {
        ...
        special: {
          ...
          click: {
            ...
            trigger: function(e) {
              var t = this || e;
              return (
                ge.test(t.type) && t.click && D(t, "input") && Le(t, "click"),
                !0
              );
            },
            _default: function(e) {
  ...
  function(e, t, n) {
    e.exports = n.p + "assets/ac43fcda1317d53619d7879cbc73284e.mp3";
  },
  function(e, t, n) {
    e.exports = n.p + "assets/c418d5f5d00869d8cd6144e71246e333.mp3";
  },
  function(e, t, n) {
    e.exports = n.p + "assets/d5a27a0c2bfc8c6ae3a88829f7319083.mp3";
  },
  function(e, t, n) {
    "use strict";
    n.r(t);
    var r = n(0),
      ...
      c = n.n(l);
    const f = {
      correct: new Audio(a.a),
      incorrect: new Audio(u.a),
      finish: new Audio(c.a)
    };
    function p(e) {
      (e.volume = 1), (e.currentTime = 0), e.play();
    }
    i()(() => {
      const e = [];
      i()(".inputqa").each((t, n) => {
        ...
        const r = i()(n)
          ...
          .toString();
        i()(n).bind("keyup", () => {
          i()(n).val().length < r.length ||
            (i()(n).val() === r
              ? (i()(n).addClass("is-valid"),
                i()(n).prop("disabled", !0),
                p(f.correct),
                (e[t] = !0),
                e.reduce((e, t) => e && t)
                  ...
                  : i()(".inputqa:enabled")
                      .first()
                      .focus())
              : (i()(n).addClass("is-invalid"),
                p(f.incorrect),
                setTimeout(() => {
                  i()(n).removeClass("is-invalid"), i()(n).val("");
                }, 1e3)));
        });
      });
    });
